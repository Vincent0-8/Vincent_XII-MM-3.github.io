...
ScrollReveal().reveal(".pizzas h1, .footer, .blogs h1", {
  origin: "bottom",
});

ScrollReveal().reveal(
  ".steps, .pizzas, .menu, .contact .icon-container, .contact .row",
  {
    origin: "top",
  }
);

ScrollReveal().reveal(".banner, .gallery, .blogs .box-container ", {
  origin: "left",
});
